...
namespace Common
{
    ...
    public static class SceneHelper
    {
        ...
        public static void LoadSceneAsync(string SceneName, Action<bool> callback)
        {
            m_levelScript.StartCoroutine(DoLoadScene(SceneName, callback));
        }

        private static IEnumerator DoLoadScene(string SceneName, Action<bool> callback)
        {

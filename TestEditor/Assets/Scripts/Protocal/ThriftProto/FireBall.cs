...
namespace BubbleCouple
{
  ...
  [Serializable]
  #endif
  public partial class FireBall : TBase
  {
    private int _type;
    ...
    public bool IsFlyout
    {
      ...
      set
      {
        __isset.isFlyout = true;
        this._isFlyout = value;
      }
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("FireBall");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("FireBall(");
      bool __first = true;
      if (__isset.type) {
